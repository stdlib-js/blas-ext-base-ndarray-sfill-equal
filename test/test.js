...
tape( 'the function replaces elements equal to a provided search element', function test( t ) {
	var searchElement;
	var expected;
	var actual;
	var alpha;
	...
	xbuf = new Float32Array( [ 0.0, -2.0, 3.0, 0.0, 4.0, -6.0 ] );
	x = vector( xbuf, 6, 1, 0 );
	...
	actual = sfillEqual( [ x, searchElement, alpha, start, end ] );
	t.strictEqual( actual, x, 'returns expected value' );

	expected = new Float32Array( [ 5.0, -2.0, 3.0, 5.0, 4.0, -6.0 ] );
...
tape( 'the function supports an input ndarray having a non-unit stride', function test( t ) {
	...
	expected = new Float32Array( [ 5.0, -2.0, 3.0, 0.0, 4.0, -6.0 ] );
	t.strictEqual( isSameFloat32Array( getData( actual ), expected ), true, 'returns expected value' );
...
tape( 'the function supports an input ndarray having a non-zero offset', function test( t ) {
	...
	expected = new Float32Array( [ 0.0, -2.0, 3.0, 5.0, 4.0, -6.0 ] );
	t.strictEqual( isSameFloat32Array( getData( actual ), expected ), true, 'returns expected value' );
...
tape( 'the function supports a nonnegative starting index', function test( t ) {
	...
	expected = new Float32Array( [ 0.0, 5.0, 5.0, 5.0 ] );
	t.strictEqual( isSameFloat32Array( getData( actual ), expected ), true, 'returns expected value' );
...
tape( 'the function supports a nonnegative ending index', function test( t ) {
	...
	expected = new Float32Array( [ 5.0, 5.0, 5.0, 0.0 ] );
	t.strictEqual( isSameFloat32Array( getData( actual ), expected ), true, 'returns expected value' );
...
tape( 'the function supports specifying a fill range for an input ndarray having a non-unit stride', function test( t ) {
	...
	xbuf = new Float32Array( [ 0.0, -2.0, 0.0, 4.0 ] );
	x = vector( xbuf, 2, 2, 0 );
	searchElement = scalar2ndarray( 0.0, {
		'dtype': 'float32'
	});
	...
	expected = new Float32Array( [ 0.0, -2.0, 5.0, 4.0 ] );
	t.strictEqual( isSameFloat32Array( getData( actual ), expected ), true, 'returns expected value' );

	t.end();
});

tape( 'if all elements are not equal to a provided search element, the function returns the input ndarray unchanged', function test( t ) {
	var searchElement;
	var expected;
	var actual;
	var alpha;
...
tape( 'if provided a search element equal to `NaN`, the function returns the input ndarray unchanged', function test( t ) {
	var searchElement;
	var expected;
	var actual;
	var alpha;
	...
	xbuf = new Float32Array( [ NaN, 1.0, NaN ] );
	x = vector( xbuf, 3, 1, 0 );
	...
	expected = new Float32Array( [ NaN, 1.0, NaN ] );
	t.strictEqual( isSameFloat32Array( getData( actual ), expected ), true, 'returns expected value' );
...
tape( 'the function does not replace `NaN` elements', function test( t ) {
	...
	xbuf = new Float32Array( [ NaN, 0.0, NaN ] );
	x = vector( xbuf, 3, 1, 0 );
	searchElement = scalar2ndarray( 0.0, {
		'dtype': 'float32'
	});
	...
	expected = new Float32Array( [ NaN, 5.0, NaN ] );
	t.strictEqual( isSameFloat32Array( getData( actual ), expected ), true, 'returns expected value' );
...
tape( 'the function considers `-0` and `+0` to be the same value', function test( t ) {
	...
	xbuf = new Float32Array( [ -0.0, 1.0, 0.0, -0.0 ] );
	x = vector( xbuf, 4, 1, 0 );
	searchElement = scalar2ndarray( 0.0, {
		'dtype': 'float32'
	});
	...
	expected = new Float32Array( [ 5.0, 1.0, 5.0, 5.0 ] );
	t.strictEqual( isSameFloat32Array( getData( actual ), expected ), true, 'returns expected value' );
